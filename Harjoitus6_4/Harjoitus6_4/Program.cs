...
namespace Harjoitus6_4
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Kirjailija.Kirja kirja1 = new Kirjailija.Kirja("Helvetistä itään","Karo Hämäläinen","Otava",31.34);

            Kirjailija kirjailija1 = new Kirjailija("Karo Hämäläinen","Huomenna",kirja1);
