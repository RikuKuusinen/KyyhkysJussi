...
namespace KyyhkysJussi
{
    public class Kartta //Anni
    {
        ...
        string[] HuoneenKuvaus =
            ...
            "13 Sieraimiisi sulloutuvat suunnattomat sulotuoksut. Mökissä leipuriörkki Tomppa vääntää torttua virne naamallaan. Pullaa paistuu uunissa Pohjoiseen päin avautuu komia niitty, jossa näkyy jonkunlaista liikettä",
