...
namespace KyyhkysJussi
{
    public class Kartta //Anni, Henni
    {
        ...
        string[] HuoneenKuvaus =
            ...
            "11 Olet omassa mökissäsi. Huoneessa on pöytä, jonka päällä on silinterihattu. Pohjoisella, läntisellä ja itäisellä seinällä on ikkunoita. Etelään päin on ovi, jossa on komea koirajuliste.",
