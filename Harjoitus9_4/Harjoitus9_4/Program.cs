...
namespace Harjoitus9_1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            lista.SetByIndex(3, j4);

            Console.WriteLine("Jumppa 2 indeksi listassa: " + lista.IndexOfValue(j2));

            IList hakuAvainlista = lista.GetKeyList();
            ...
            IList arvoLista = lista.GetValueList();

            Console.WriteLine("\nJa alla arvot tulostettuna: ");

            for (int i = 0; i < lista.Count; i++)
                Console.WriteLine(arvoLista[i] + " ");
